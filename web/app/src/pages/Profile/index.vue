...
/**
 * @fileoverview 个人资料自服务：改资料与改密码。
 * 两个动作都不要求任何权限码——它们只作用于自己。
 */
import { ref } from 'vue'
...
<template>
  <AppShell title="个人资料" subtitle="改自己的资料与密码">
    <!-- main 不滚了，这一页自己吃满高度并在内部滚 -->
    <div
      class="h-full min-h-0 gap-5 overflow-y-auto pr-1 lg:grid lg:grid-cols-2 lg:content-start"
    >

...
export const ICONS = {
  ...
  paperclip: [
    ...
    'm16 6-8.414 8.586a2 2 0 0 0 0 2.828 2 2 0 0 0 2.828 0l8.414-8.586a4 ' +
      '4 0 0 0-5.656-5.656l-8.415 8.585a6 6 0 1 0 8.486 8.486',
  ],
  send: [
  ...
  // 撤销 / 重做：弯箭头。⚠ 别用左右尖角代——那是「上一个 / 下一个」，
  // 在工具条上与撤销是两件事，用户会以为自己在翻页
  undo: [
    'M9 14 4 9l5-5',
  ...
  redo: [
    'm15 14 5-5-5-5',
    'M20 9H9.5A5.5 5.5 0 0 0 4 14.5 5.5 5.5 0 0 0 9.5 20H13',
  ],
  // 吸附：马蹄形磁铁，两极朝上
  magnet: [
    'M5 4v9a7 7 0 0 0 14 0V4',
    'M9 4v9a3 3 0 0 0 6 0V4',
    'M5 4h4',
    'M15 4h4',
  ],
  // 智能参考线：画成画布上真实出现的那对虚线，比抽象的尺子好认
  guides: ['M12 2v3', 'M12 8v8', 'M12 19v3', 'M2 12h3', 'M8 12h8', 'M19 12h3'],
  keyboard: [
  ...
  // 助手：机器人正脸。⚠ 与 `sparkles` 分开一个名字而不是改那一个——
  // 换肤器、导航与项目设置都在用它，改几何等于顺手改了那三处
  bot: [
  ...
  // 连描边最远也只到 x=2 与 x=22，落在视框内
  link: ['M10 8H7a4 4 0 0 0 0 8h3', 'M14 8h3a4 4 0 0 1 0 8h-3', 'M9 12h6'],
  // 只用直线：圆弧鼓出多少从字面坐标上看不出来，越出视框会被静默裁掉
  image: ['M4 4h16v16H4z', 'm5 16 4-4 3 3 4-4 3 3', 'M9 9h.01'],
  // 两点测量：一把带刻度的尺
  ruler: ['M3 8h18v8H3z', 'M7 8v4', 'M11 8v4', 'M15 8v4'],
  // 采集面：数据源（机柜）、地址空间（拓扑）、启停与归档
  server: [
  ...
  // 分析建模：两个上游方块经折角连线汇进下游方块，即一张有向图
  // 折角是四分之一圆弧，鼓不出两端点连成的盒，所以极值就是字面坐标
  workflow: [
    'M4 2h4a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1Z',
    'M4 16h4a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-4a1 1 0 0 1 1-1Z',
    'M16 9h4a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1v-4a1 1 0 0 1 1-1Z',
    'M9 5h2a2 2 0 0 1 2 2v3a2 2 0 0 0 2 2',
    'M9 19h2a2 2 0 0 0 2-2v-3a2 2 0 0 1 2-2',
  ],
  database: [
    'M21 5A9 3 0 0 1 3 5a9 3 0 0 1 18 0',
    'M3 5v14a9 3 0 0 0 18 0V5',
    'M3 12a9 3 0 0 0 18 0',
  ],
  'database-zap': [
    'M21 5A9 3 0 0 1 3 5a9 3 0 0 1 18 0',
    'M3 5v14a9 3 0 0 0 12 2.84',
    'M21 5v3',
    'm21 12-3 5h4l-3 5',
    'M3 12a9 3 0 0 0 11.59 2.87',
  ],
  ...
  recycle: [
    ...
    'm9.344 5.811 1.093-1.892A1.83 1.83 0 0 1 11.985 3a1.784 1.784 0 0 1 ' +
      '1.546.888l3.943 6.843',
  ...
  // 能源类型：水蓄能
  droplets: [
    'M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.57-2.26-1.71-3.19S7.29 6.75 7 5.3c' +
      '-.29 1.45-1.14 2.84-2.29 3.76S3 11.1 3 12.25c0 2.22 1.8 4.05 4 4.05z',
    'M12.56 6.6A10.97 10.97 0 0 0 14 3.02c.5 2.5 2 4.9 4 6.5s3 3.5 3 5.5a6.98 ' +
      '6.98 0 0 1-11.91 4.97',
  ],
  // 储能容器：水箱
  container: [
    'M22 7.7c0-.6-.4-1.2-.8-1.5l-6.3-3.9a1.72 1.72 0 0 0-1.7 0l-10.3 6c-.5.2' +
      '-.9.8-.9 1.4v6.6c0 .5.4 1.2.8 1.5l6.3 3.9a1.72 1.72 0 0 0 1.7 0l10.3-6c' +
      '.5-.3.9-1 .9-1.5Z',
    'M10 21.9V14L2.1 9.1',
    'm10 14 11.9-6.9',
    'M14 19.8v-8.1',

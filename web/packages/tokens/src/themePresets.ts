...
const NAIVE_GREEN: ThemeDefinition = {
  ...
  tokens: {
    surface: {
      base: '#f9f9f9',
      sunken: 'rgba(43, 47, 49, 0.035)',
      panel: '#ffffff',
      raised: 'rgba(0, 185, 171, 0.08)',
      overlay: 'rgba(255, 255, 255, 0.96)',
    },
    border: {
      subtle: 'rgba(43, 47, 49, 0.05)',
      default: 'rgba(43, 47, 49, 0.08)',
      strong: '#d9dfe0',
      hover: 'rgba(0, 185, 171, 0.45)',
    },
    text: {
      primary: '#2b2f31',
      secondary: 'rgba(43, 47, 49, 0.74)',
      disabled: 'rgba(43, 47, 49, 0.67)',
      title: '#00796f',
      inverse: '#2b2f31',
      onEmphasis: '#052622',
    },
    ...
    fx: {
      glowTitle: 'rgba(0, 185, 171, 0.16)',
      cornerColor: '#00b9ab',
      scanline: 'rgba(43, 47, 49, 0.012)',
      gridLine: 'rgba(0, 185, 171, 0.045)',
      scrim: 'rgba(26, 37, 39, 0.32)',
      shadowModal: '0 24px 64px -16px rgba(26, 37, 39, 0.2)',
      shadowMenu: '0 12px 32px rgba(26, 37, 39, 0.12)',
      shadowInset: 'inset 0 1px 2px rgba(26, 37, 39, 0.08)',
      sheen: 'rgba(255, 255, 255, 0.68)',
      transition: '0.5s ease',
    },
  },
  extraVars: {
    '--neutral-fg-rgb': '43, 47, 49',
    '--card-corner-display': 'none',
  },
}

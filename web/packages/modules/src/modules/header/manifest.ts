/**
 * @fileoverview header —— 钉在顶部的整宽容器。它自己只画外壳，标题、时钟、logo
 * 都是独立子节点，由运行时按节点树注入默认插槽（DASHBOARD_DESIGN §5.4）。
 */
...
export default defineModule({
  ...
  isContainer: true,
  region: 'header',
  defaultSize: { width: 1920, height: 96, minWidth: 240, minHeight: 48 },
  configSchema: [
    {
      key: 'title',
      label: '标题',
  ...
  bindings: [],
  preview: { config: { title: '数字孪生大屏', showTitle: true } },

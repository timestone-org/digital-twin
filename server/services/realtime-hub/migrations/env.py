...
迁移链绑定 `realtime` schema 并把版本表也放在里面——每个服务只操作自己的 schema，
...
from realtime_hub.apps.channel.models import Base
from realtime_hub.settings import DB_SCHEMA, MigrationSettings

...
迁移链绑定 `collect` schema 并把版本表也放在里面——每个服务只操作自己的
...
from collector_server.apps.collect.models import Base
from collector_server.settings import DB_SCHEMA, MigrationSettings
